...
exports.home_page = async (req, res, next) => {
  ...
  const _data_5 = await sequelize.query(`SELECT el.* FROM event_list el WHERE status = 1 and event_session != "Upcoming" ORDER BY el.id DESC LIMIT 1;`, { type: QueryTypes.SELECT });
